...
@section('content')
    ...
    <div id="sale">
        @if ($model)
            <div class="alert alert-warning">
                ...
                <h1>Ya existe un corte de caja de tipo <strong>{{$type}}</strong> para el día de hoy
    ...
    $model->getRawOriginal('status') == $model::STATUS_WAITING_AUTH)
                ...
                @endif
                @if (auth()->user()->hasRole(['Punto de venta']) &&
    $model->getRawOriginal('status') == $model::STATUS_CLOSE)
