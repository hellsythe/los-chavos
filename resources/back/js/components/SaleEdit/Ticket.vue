<template>
    <div id="ticket" style="display: none;">
        <div style="width: 170px; padding: 2px; font-size: 12px;">
            ...
            <p style="text-align: center;">“Favor de corroborar su nota verificando que los datos de su servicio sean correctos, tal como usted lo solicita, no nos hacemos responsables si usted no los verifica”</p>
            <p style="text-align: center;">“Todas las entregas de servicio son a partir de las 18:00 hrs del día de la entrega”</p>
        </div>
    </div>
</template>
