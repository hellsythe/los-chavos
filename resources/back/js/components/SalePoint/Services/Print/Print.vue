    ...
    <div class="form-control mb-2 mr-2">
        ...
        <div v-show="service.detail.is_new_design && service.detail.design_is_here">
            ...
            <div class="form-control w-full mb-2 mr-2">
                ...
                <a v-if="service.detail?.design_print?.media" target="_blank" class="btn btn-neutral" :href="service.detail.design_print.media.replace('https://los-chavos.site', '')" download> Descargar Archivo  </a>
            </div>
        </div>
